<?php
// auth.php - Fixed Authentication Class
...
class Auth {
    ...
    public function register($data) {
        ...
        if (!empty($existing)) {
            throw new Exception('Username sudah digunakan', 400);
        }
    ...
    public function login($username, $password) {
        ...
        if (!$user['is_active']) {
            throw new Exception('Akun Anda dinonaktifkan', 403);
        }
